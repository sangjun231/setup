...
// open weather api 에서 return 하는 json 중 
// data.weather[0].main 의 모든 프로퍼티
// 오른쪽의 값은 openweathermap 에서 제공하는 날씨별 icon 코드
const allMainWeathers = {
  Thunderstorm : "11d",
  Drizzle : "09d",
  Rain : "09d",
  Snow : "13d", 
...
// 아이콘 url 예시(현재 맑음일 경우)
let iconUrl = `https://openweathermap.org/img/wn/${allMainWeathers.Clear}@2x.png`
